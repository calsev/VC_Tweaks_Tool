...
simple_triggers = [
  ...
  (24,
    [
      ...
      (try_for_range,":monastery","p_monasterio1","p_yourlair"),
        (party_get_slot,":val",":monastery",slot_center_volunteer_troop_type),
        (neq,":val",0),#0 = can recruit
        (val_sub,":val",1),
        (val_max,":val",0),#to clear negative values (errors)
        (party_set_slot,":monastery",slot_center_volunteer_troop_type,":val"),
      (try_end),
      #updating berserkers in hof
      (try_for_range,":hof","p_paganholysites1","p_oldpagan_hut"),
  ...
  (1.4,
    [
      ...
      (this_or_next|eq, TWEAK_PLAYER_CENTERS_GENERATE_GARRISON, 1),
      ...
      (try_begin), # TWEAK FOR GARRISON
        (is_between, ":center_no", castles_begin, castles_end),
        (assign, ":limit", TWEAK_GARRISON_LIMIT_FOR_FORTS-50),
        (val_min, ":limit", ":base"),
      (else_try),
        (is_between, ":center_no", towns_begin, towns_end),
        (assign, ":limit", TWEAK_GARRISON_LIMIT_FOR_TOWNS-50),
        (val_min, ":limit", ":base"),
      (try_end),
  ...
  (1.8,
    [(eq, TWEAK_DISABLE_ADVENTURERS, 0),
  ...
  (24,
    [(try_for_range, ":troop_no", active_npcs_begin, companions_end),
  ...
  (24,
    [
      ...
      (eq, TWEAK_STOP_TROOPS_STEALING_FROM_CAMP, 0),
  ...
  (.025,
    [
      ...
      (try_begin),
        ...
        (store_sub, ":random_up_limit", ":strength_ratio", TWEAK_AI_REQUIRED_STRENGHT_TO_ATTACK_SIEGE), #was 300 (1.126)
  ...
  (0.1,
    [
      ...
      (try_for_parties, ":bandit_camp"),
        ...
        (lt, ":distance", TWEAK_BANDIT_LAIR_VISIBLE_FROM_DISTANCE),
  ...
  (.27,
    [
      ...
      (else_try),
        ...
        (neq, ":cur_faction", "fac_adventurers"),
        (try_begin),
  ...
  (TWEAK_EAT_EVERY_X_HOURS, #chief change 12 hours. In ancient and dark ages, men did two meals each day
    [
      (eq, "$g_player_is_captive", 0),
      ...
      (val_div, ":num_men", TWEAK_EAT_HOW_MUCH), #1 piece of food let eat 3 men
      (try_begin),
        (eq, ":num_men", 0),
        (val_add, ":num_men", 1),
      (try_end),
  ...
  (7 * 24, [
      (troop_get_slot, ":player_renown", "trp_player", slot_troop_renown),
      (store_div, ":renown_decrease", ":player_renown", TWEAK_RENOWN_LOSS_EVERY_WEEK),
  ...
  (0.62,
    [
      ...
      (try_begin),
        ...
        (lt, ":faith", 99),
        (try_begin),
          (store_random_in_range, ":random", 0, ":faith"),
          (try_begin),
            (gt, ":random", 40),
          ...
          (try_begin),
            ...
            (eq, ":religion", 1),
            (val_add, "$faith_conversion", ":rand"), #control conversions for minister
          (else_try),
            (faction_slot_eq, ":faction", slot_faction_leader, "trp_player"),
            (eq, ":religion", 2),
            (val_sub, "$faith_conversion", ":rand"), #control conversions for minister
          (try_end),
        (try_end),
      (else_try),
        ...
        (lt, ":p_faith", 99),
        (try_begin),
          (store_random_in_range, ":random", 0, ":p_faith"),
          (try_begin),
            (gt, ":random", 40),
            (store_random_in_range, ":rand", 0,4),
            (val_add, ":p_faith", ":rand"),
      ...
      # JuJu70 - religion adjustment without monasteries
      (party_get_slot, ":faith", ":center_no", slot_center_faithratio),
      ...
      (party_set_slot, ":center_no", slot_center_faithratio, ":faith"),
      # JuJu70
      # Nearby monastery affects religion
      (party_get_slot, ":faith", ":center_no", slot_center_faithratio),
      (try_begin),
  ...
  (TWEAK_FREQUENCY_RELIGION_AFFECTING_RELATIONS, [ #default 8 hours
            ...
            (try_begin),
              ...
              (try_begin),
                ...
                (try_begin),
                  ...
                  (try_begin),
                    (eq, TWEAK_DISABLE_ALERT_CENTER_ATTACKED, 0),
  ...
  #(6, #monasterios religion once per week ON AVERAGE
  #	[
  # (store_random_in_range, ":center_no", "p_monasterio1", "p_yourlair"),
      ...
      (try_for_range, ":center_no", centers_begin, centers_end),
        ...
        (try_begin),
          ...
          (try_begin),
            ...
            (try_begin),
              (party_slot_eq, ":center_no", slot_village_state, svs_normal),
              (assign, ":cur_rents", TWEAK_BASE_INCOME_VILLAGE),
            (try_end),
          (else_try),
            (neg|party_slot_ge, ":center_no", slot_party_looted_left_days, 1),
            (party_slot_eq, ":center_no", slot_party_type, spt_castle),
            (assign, ":cur_rents", TWEAK_BASE_INCOME_FORT),
          (else_try),
            (neg|party_slot_ge, ":center_no", slot_party_looted_left_days, 1),
            (party_slot_eq, ":center_no", slot_party_type, spt_town),
            (assign, ":cur_rents", TWEAK_BASE_INCOME_TOWN),
          (try_end),
  ...
  (ti_on_switch_to_map, [
      ...
      (try_begin),
        ...
        (party_template_set_slot, "pt_frank_looters_1", slot_party_template_lair_type, "pt_forest_bandit_lair"),
        (party_template_set_slot, "pt_frank_looters_2", slot_party_template_lair_type, "pt_forest_bandit_lair"),
